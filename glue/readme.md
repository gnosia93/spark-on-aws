...
* [CSV 를 파퀘어 변환하기 및 파티셔닝 적용](https://github.com/gnosia93/spark-on-aws/blob/main/glue/parquet-partitioning.ipynb)

* [GLUE 인터랙티브 노트북에서 아파치 IceBerg 테이블 다루기](https://github.com/gnosia93/spark-on-aws/blob/main/glue/apache-iceberg.ipynb)

* [GLUE Studio 로 glue 4.0 테스트]()


https://docs.aws.amazon.com/glue/latest/dg/migrating-version-40.html#migrating-version-40-features
...
### Iceberg ###
* https://docs.aws.amazon.com/ko_kr/glue/latest/dg/aws-glue-programming-etl-format-iceberg.html
* https://aws.amazon.com/es/blogs/big-data/automate-replication-of-relational-sources-into-a-transactional-data-lake-with-apache-iceberg-and-aws-glue/
